...
HttpHelper.prototype.addTlsOptions = function(options) {
    var pfx = process.env.HTTP_ADAPTER_PFX;
    var key = process.env.HTTP_ADAPTER_KEY;
    var cert = process.env.HTTP_ADAPTER_CERT;
    var passphrase = process.env.HTTP_ADAPTER_PASSPHRASE;

    if (pfx || key || cert || passphrase) options.agentOptions = {};
