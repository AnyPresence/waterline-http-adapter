...
var maps = {
    'json': function(model, action, context) {
                return new mappers.JsonMapper(model, action, context);
            },
    'xml': function(model, action, context) {
                return new mappers.XmlMapper(model, action, context);
            }
};
